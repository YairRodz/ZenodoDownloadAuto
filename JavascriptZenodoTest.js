...
const searchAndDownload = async (authorName = null, communityName = null, userName) => {
    ...
    fs.writeFileSync(path.join(searchPath, `${authorName}_${communityName}_${searchStartTime}_${searchEndTime}_${userName}_${searchDate.toISOString().split('T')[0]}.json`), JSON.stringify(searchInfo));
